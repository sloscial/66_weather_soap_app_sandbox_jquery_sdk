YUI.add("yuidoc-meta", function(Y) {
   Y.YUIDoc = { meta: {
    "classes": [
        ...
        "Cookie",
        "GetCityWeatherByZip",
        "GetCityWeatherByZipAll",
        "GetCityWeatherByZipCount",
        "GetCityWeatherByZipCountExactMatch",
        "GetCityWeatherByZipExactMatch",
        "HasMany",
        "HasOne",
        "MockServer",
        "Model",
    ...
    "allModules": [
        ...
        },
        {
            ...
            "name": "collections",
            "description": "GetCityWeatherByZipAllis a scope collection for application `WeatherSoapAppSdk`.  See\n`AP.collection.ScopeCollection` for more information about scopes."
        },
        {
        ...
        },
        {
            "displayName": "models",
            "name": "models",
            "description": "GetCityWeatherByZip model for application `WeatherSoapAppSdk`.  See\n`AP.model.Model` for more information about models."
        },
        {
