...
collectionName = 'WeatherByZipExactMatch'


describe 'Scope Collection Class:  WeatherSoapAppSdk.collections.WeatherByZipExactMatch', ->
  ...
  it 'performs GET requests with query parameters and, on success, contains model instances of `WeatherByZip`', (done) ->
