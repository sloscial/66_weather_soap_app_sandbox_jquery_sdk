...
collectionName = 'WeatherByZipAll'


describe 'Scope Collection Class:  WeatherSoapAppSdk.collections.WeatherByZipAll', ->
  ...
  it 'performs GET requests and, on success, contains model instances of `WeatherByZip`', (done) ->
