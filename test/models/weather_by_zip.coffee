...
describe 'Model Class:  WeatherSoapAppSdk.models.WeatherByZip', ->
  ...
  describe 'fields', ->
    ...
    it 'has a field `get_city_weather_by_zip` of type `string`', ->
      fieldDefinition = _.findWhere(modelClass::fieldDefinitions, {name: 'get_city_weather_by_zip'})
      assert.isDefined fieldDefinition
      assert.equal fieldDefinition.type, 'string'
    
    
    it 'has a field `get_city_weather_by_zip_response` of type `string`', ->
      fieldDefinition = _.findWhere(modelClass::fieldDefinitions, {name: 'get_city_weather_by_zip_response'})
      assert.isDefined fieldDefinition
      assert.equal fieldDefinition.type, 'string'
