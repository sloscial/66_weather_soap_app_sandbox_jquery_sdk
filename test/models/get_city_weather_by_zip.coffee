...
describe 'Model Class:  WeatherSoapAppSdk.models.GetCityWeatherByZip', ->
  ...
  describe 'fields', ->
    ...
    it 'has a field `get_city_weather_by_zip_result` of type `string`', ->
      fieldDefinition = _.findWhere(modelClass::fieldDefinitions, {name: 'get_city_weather_by_zip_result'})
      assert.isDefined fieldDefinition
