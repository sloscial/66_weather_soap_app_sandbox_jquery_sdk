...
class WeatherSoapAppSdk.models.GetCityWeatherByZip extends AP.model.Model
  ...
  @type String
  ###
  urlRoot: '/api/v12/get_city_weather_by_zips'
...
@extends AP.collection.ScopeCollection
###
class WeatherSoapAppSdk.collections.GetCityWeatherByZipAll extends AP.collection.ScopeCollection
  ###*
  ...
  @type String
  ###
  apiEndpoint: '/api/v12/get_city_weather_by_zips.json'
...
@extends AP.collection.AggregateCollection
###
class WeatherSoapAppSdk.collections.GetCityWeatherByZipCountExactMatch extends AP.collection.AggregateCollection
  ###*
  The collection ID may be used to look-up a collection from an
  application class.
  @property collectionId
